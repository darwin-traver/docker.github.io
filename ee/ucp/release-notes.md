...
### Kubernetes
* Kubernetes has been updated to version 1.11.7. (docker/orca#16157).  For more information, see the [Kubernetes Release Notes](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.11.md#v1117).
...
* Core
   ...
   * Calico has upgraded to version 3.0.8. For more information, see the [Calico Release Notes](https://docs.projectcalico.org/v3.0/releases/).
